...
import com.denada.travpholer.util.BitmapUtil;
import com.denada.travpholer.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR =Color.argb(0xFF, 0xff, 0xff, 0xff);// Color.argb(0xFF, 0x33, 0xB5, 0xE5);
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            try {
                ...
                mDefaultColor = a.getColor(R.styleable.RangeSeekBar_defaultColor, ACTIVE_COLOR);
