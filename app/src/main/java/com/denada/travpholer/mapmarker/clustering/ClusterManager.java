...
package com.denada.travpholer.mapmarker.clustering;
...
import com.denada.travpholer.mapmarker.clustering.algo.Algorithm;
import com.denada.travpholer.mapmarker.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.denada.travpholer.mapmarker.clustering.algo.PreCachingAlgorithmDecorator;
import com.denada.travpholer.mapmarker.clustering.view.ClusterRenderer;
 ...
 * <p/>
 * ClusterManager should be added to the map as an: <ul> <li>{@link GoogleMap.OnCameraChangeListener}</li>
